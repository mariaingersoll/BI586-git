...
##In order for the hyperlink to be inserted you have to knit the file, then the hyperlink will be there and titled bookdown bc that's what you named it
...
```{r, fig.cap="caption"}
knitr::include_graphics('IMG_0563.jpg')
```

#Question 7 
**Add any png to your markdown html**
#See above
#.jpeg or .jpg works too
